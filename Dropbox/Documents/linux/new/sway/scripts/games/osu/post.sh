...
sed -i "s/^Fullscreen = 0/Fullscreen = 1/g" $HOME/Games/osu/game/osu\!.marco.cfg
sed -i "s/^RawInput = 0/RawInput = 1/g" $HOME/Games/osu/game/osu\!.marco.cfg
sed -i "s/^Letterboxing = 0/Letterboxing = 1/g" $HOME/Games/osu/game/osu\!.marco.cfg
